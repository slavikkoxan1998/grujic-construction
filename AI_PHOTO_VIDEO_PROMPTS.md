...
**Головне правило: кожне фото має ілюструвати саме те, що написано в `workItems` цього проєкту** (розділ "Co jsme realizovali" на сторінці `/projekty/{slug}`) — не просто загальну тему категорії. Тому нижче під кожен проєкт — окремий промпт **на кожен пункт `workItems`** (1:1 відповідність тексту й фото), плюс додаткові кадри — разом **6 промптів фото на кожен із 10 проєктів**.
...
6. "Aerial drone view of a modern two-story house with dark facade and flat roof, green lawn, driveway, daylight, photorealistic, high detail"
...
6. "Close-up of hands applying adhesive mortar and installing an insulation panel on a building facade, notched trowel, gray render, photorealistic, high detail, sharp focus"
...
6. "Construction worker grouting bathroom wall tiles with a rubber float, close-up of hands, gray tile joints, photorealistic, high detail, sharp focus"
...
6. "Wide shot of an open-plan office space mid-renovation, partial drywall partitions, exposed ceiling with cable trays, construction materials stacked, daylight, photorealistic, construction photography"
...
6. "Dump truck delivering gravel to a construction site foundation area, excavator working nearby, blue sky, wide angle, photorealistic, construction photography"
...
6. "Close-up of an excavator hydraulic claw lifting broken concrete debris, dust in the air, daylight, photorealistic, high detail, dramatic"
...
6. "Underfloor heating pipe installation in a new building, orange PEX pipes laid in a spiral pattern on insulation boards before concrete pour, photorealistic, high detail, wide angle"
...
6. "Before and after style photo of a wall - half showing old worn paint with cracks, half showing fresh smooth white paint, photorealistic, high detail"
...
6. "Bare concrete ceiling before renovation in an apartment room, exposed wiring, preparation stage, photorealistic, construction photography, high detail"
...
6. "Construction worker unrolling a large roll of waterproofing membrane across a flat roof surface, daylight, photorealistic, construction photography, high detail"
